...
<div class="container-600">
	...
	<form action="challengeJoin.kh" method="post" class="join-form">
		<div class="row text-left">
			...
			<input type="text" class="form-input" name="challengeTitle" placeholder="도전글 제목" id="title">
		</div>
		<div class="row text-left">
			<label for="pushPoint">참가비</label>
			<input type="number" class="form-input" name="challengePushPoint" id="pushPoint">
		</div>
		<div class="row text-left">
			<label for="startDate">시작일</label>
			<input type="date" class="form-input" name="challengeStartDate" id="startDate">
		</div>
		<div class="row text-left">
